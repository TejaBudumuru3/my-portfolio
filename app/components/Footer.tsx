...
export const Footer = () => {
    return (
        <div className="flex justify-between gap-8 text-white font-extrabold bg-transparent py-6 ">
            <div className="flex flex-col md:flex-row p-2 md:px-8 text-2xl justify-between w-full gap-2">
                <div className="place-self-center">
                    <h1 className="text-lg md:text-xl lg:text-2xl">Srinivas Sai Sara Teja Budumuru</h1>
